  ...
  return (
    <>
      <header>
        ...
        <div className="relative h-96 overflow-hidden bg-[url('https://mdbootstrap.com/img/Photos/Inne/ostia.jpg')] bg-cover bg-no-repeat p-12 text-center lg:h-screen">
          <div
            className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"
            style={{
              backgroundColor: "rgba(2, 56, 53, 0.7)",
            }}
          >
