...
export default function Container({}: ContainerProps) {
  return (
    <>
      ...
      <div
        className="offcanvas offcanvas-top invisible fixed bottom-0 top-0 left-0 right-0 flex h-1/3 max-h-full max-w-full flex-col border-none bg-white bg-clip-padding text-gray-700 shadow-sm outline-none transition duration-300 ease-in-out"
        tabIndex={-1}
        id="offcanvasTop"
