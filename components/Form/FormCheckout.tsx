  ...
  return (
    <>
      <div
        ...
        py-16 px-4 md:px-6
        2xl:container 2xl:mx-auto 2xl:px-0"
      >
        <div
        ...
        >
          ...
          <div
            ...
            space-y-6 xl:flex-row xl:justify-between xl:space-y-0 xl:space-x-6"
          >
            <div
            ...
            >
              ...
              >
                ...
                <p
                  ...
                  px-4
                  text-base leading-4 text-gray-600"
                >
                  or pay with card
                </p>
                <hr
              ...
              <div className="mt-2">
                <div className="relative">
                  <button
                    ...
                    bg-white
                    p-4
                    text-left text-base leading-4 text-gray-600
                    placeholder-gray-600"
                    name=""
                  >
                    United States
                  ...
                  <svg
                    id="openIcon"
                    className="absolute top-4 right-4 hidden rotate-180 transform cursor-pointer"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
