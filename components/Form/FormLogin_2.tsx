    ...
    <>
      <div className="relative flex min-h-screen ">
        <div className="flex min-w-0 flex-auto flex-col items-center bg-white sm:flex-row sm:justify-center md:items-start md:justify-start">
          <div className="relative hidden h-full flex-auto items-center justify-center overflow-hidden bg-purple-900 bg-[url(https://images.unsplash.com/photo-1579451861283-a2239070aaa9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80)] bg-cover bg-no-repeat p-10 text-white sm:w-1/2 md:flex xl:w-3/5">
          ...
          <div className="w-full w-2/5 bg-white p-8 sm:w-auto sm:rounded-lg md:flex md:h-full md:items-center  md:justify-center md:rounded-none md:p-10 lg:p-14 xl:w-2/5">
            <div className="w-full max-w-md space-y-8">
              ...
              <div className="flex flex-row items-center justify-center space-x-3">
                <a
                  ...
                  className="inline-flex h-11 w-11 cursor-pointer items-center justify-center rounded-2xl bg-blue-900   text-lg font-bold transition duration-300 ease-in hover:shadow-lg"
                >
                  <img
                    className="h-4 w-4"
                ...
                <a
                  ...
                  className="inline-flex h-11 w-11 cursor-pointer items-center justify-center rounded-2xl bg-blue-400  text-lg font-bold text-white transition duration-300 ease-in hover:shadow-lg"
                >
                  <img
                    className="h-4 w-4"
                ...
                <a
                  ...
                  className="inline-flex h-11 w-11 cursor-pointer items-center justify-center rounded-2xl bg-blue-500  text-lg font-bold text-white transition duration-300 ease-in hover:shadow-lg"
                >
                  <img
              ...
              <form className="mt-8 space-y-6" action="#" method="POST">
                ...
                <div className="relative">
                  ...
                  <input
                    className=" w-full rounded-2xl border-b border-gray-300 px-4 py-2 text-base focus:border-indigo-500 focus:outline-none"
                    type=""
                ...
                <div className="mt-8 content-center">
                  ...
                  <input
                    className="w-full content-center rounded-2xl border-b border-gray-300 px-4 py-2 text-base focus:border-indigo-500 focus:outline-none"
                    type=""
                ...
                <div>
                  <button
                    type="submit"
                    className="flex w-full cursor-pointer justify-center rounded-full bg-gradient-to-r  from-indigo-500 to-blue-600 p-4 font-semibold tracking-wide  text-gray-100 shadow-lg transition  duration-500 ease-in hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600"
                  >
                    Sign in
                  </button>
                </div>
                <p className="text-md mt-10 flex flex-col items-center justify-center text-center text-gray-500">
                  ...
                  <a
                    href="#"
                    className="cursor-pointer text-indigo-400 no-underline transition duration-300 ease-in hover:text-blue-500 hover:underline"
                  >
                    Sign up
                  </a>
                </p>
