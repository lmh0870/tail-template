...
export default function Container({}: ContainerProps) {
  return (
    <>
      <div className="w-full rounded-md bg-white px-4 pb-4">
        ...
        <div className="mt-2 flex w-full justify-end px-2">
          <div className="relative inline-block w-full sm:w-64 ">
            <input
              type=""
              name=""
              className="block w-full appearance-none rounded-lg border border-gray-300 bg-gray-100 py-1 px-4 pl-8 text-sm leading-snug text-gray-600"
              placeholder="Search"
            />

            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center px-2 pl-3 text-gray-300">
              <svg
            ...
            <tbody className="text-sm font-normal text-gray-700">
              ...
              <tr className="border-b border-gray-200 py-4 hover:bg-gray-100">
                <td className="flex items-center px-4 py-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="mr-5 h-5 w-5 fill-current"
        ...
        <div
          id="pagination"
          className="flex w-full items-center justify-center border-t border-gray-100 pt-4"
        >
          <svg
            className="h-6 w-6"
            width="24"
          ...
          <p className="mx-2 cursor-pointer text-sm leading-relaxed text-blue-600 hover:text-blue-600">
            1
          </p>
          <p className="mx-2 cursor-pointer text-sm leading-relaxed hover:text-blue-600">
            2
          </p>
          <p className="mx-2 cursor-pointer text-sm leading-relaxed hover:text-blue-600">
            {" "}
