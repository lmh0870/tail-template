  ...
  return (
    <>
      <nav
        ...
        navbar-light relative flex w-full flex-wrap items-center justify-between bg-gray-900 py-3 text-gray-200 shadow-lg"
      >
        <div className="container-fluid flex w-full flex-wrap items-center justify-between px-6">
          ...
          <div className="relative flex items-center">
            ...
            <div className="dropdown relative">
              <a
                className="hidden-arrow dropdown-toggle mr-4 flex items-center text-white opacity-60 hover:opacity-80 focus:opacity-80"
                href="#"
