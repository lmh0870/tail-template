      ...
      >
        ...
        <header className="absolute top-0 left-0 right-0 z-20">
          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                <a href="#" className="text-white">
                  <svg
                    className="mr-2 w-6 fill-current"
            ...
            >
              <a
                className="py-2 px-2
                text-sm uppercase text-gray-200
                hover:bg-indigo-500"
              >
                About us
              </a>
        ...
        >
          ...
          <div
            ...
            lg:w-3/5 xl:w-2/5"
          >
            <span className="uppercase text-indigo-500">Lorem ipsum</span>
            <h1
              className="mt-4
              text-4xl leading-tight text-red-400
              sm:text-6xl"
            >
              Lets go <br /> back to school
            </h1>
          ...
          >
            ...
            <g data-name="Capa 1">
              ...
              <path
                ...
                opacity=".5"
                className="mix-blend-mode:lighten"
              />
              <path
                fill="#926279"
