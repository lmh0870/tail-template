  ...
  return (
    <>
      <div
        ...
        bg-gradient-to-br from-indigo-900 to-green-900"
      >
        <div
          ...
          >
            ...
            >
              <div
                ...
                px-6 py-5
                shadow-xl
                ring-2 ring-cyan-700 ring-offset-2 ring-offset-blue-800
                transition
              ...
              >
                ...
                <div>
                  <i
                    ...
                    block
                    -translate-x-1
                    transform opacity-0 transition
              ...
              >
                ...
                <div>
                  <i
                    className="fa fa-chevron-right
                    block
                    -translate-x-1 transform opacity-0 transition
                    group-hover:translate-x-0
                    group-hover:opacity-100"
                  ></i>
                </div>
