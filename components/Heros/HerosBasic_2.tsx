      ...
      <main className="bg-gray-100">
        ...
        >
          ...
          >
            <div
              ...
              text-2xl font-black text-blue-900"
            >
              Company
              <span
                className="ml-2
        ...
        >
              ...
              <g className="isolation:isolate">
                <g id="Capa_1" data-name="Capa 1">
                  ...
                  <polygon
                    ...
                    className="fill:#8382b3"
                  />
                  <path
                    d="M236.84,30.58l-1.18.78"
                    className="fill:none;stroke:#8382b3;stroke-miterlimit:10;stroke-width:0.992126px"
                  />
                  <path
                    ...
                    className="fill:none;stroke:#8382b3;stroke-miterlimit:10;stroke-width:0.992126px;stroke-dasharray:2.864720106124878,5.729430198669434"
                  />
                  <path
                  ...
                  <path
                    d="M82.48,92.92c-1.25,3.55-13,7.67-13,7.67s35.57,40.73,49.3,40.47-6-38.4-6-38.4-4-2-5.25-5.88,1.37-20.54,1.37-20.54L94.39,67.37S83.73,89.37,82.48,92.92Z"
                    className="mix-blend-mode:multiply;fill:url(#linear-gradient-5)"
                  />
                  <path
                  ...
                  <path
                    ...
                    className="fill:url(#linear-gradient-6)"
                  />
                  <path
                  ...
                  <path
                    ...
                    className="fill:url(#linear-gradient-9)"
                  />
                  <path
                  ...
                  <path
                    ...
                    className="fill:url(#linear-gradient-13)"
                  />
                  <path
                  ...
                  <line
                    ...
                    x2="194.99"
                    y2="172.78"
                    className="fill:none;stroke:#eaf0f2;stroke-miterlimit:10;stroke-width:0.30236199999999996px"
                  />
                  <path
                    d="M201.49,159.22a6.51,6.51,0,1,1-6.5-6.36A6.43,6.43,0,0,1,201.49,159.22Z"
                    className="fill:#807fb4"
                  />
                  <path
          ...
          >
            <h1
              className="mb-4
              text-4xl font-black leading-none text-blue-900
              lg:text-5xl"
            >
          ...
          >
            ...
            <rect
              ...
              width="0.99"
              height="50.47"
              className="fill:#f3f8f5;opacity:0.43"
            />
            <rect
              x="113.86"
              y="98.39"
