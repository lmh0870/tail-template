...
export default function Container({}: ContainerProps) {
  return (
    <>
      <div
        className="absolute h-full w-60 bg-white px-1 shadow-md"
        id="sidenavExample"
      >
        <ul className="relative">
          <li className="relative" id="sidenavEx1">
            <a
              className="flex h-12 cursor-pointer items-center overflow-hidden text-ellipsis whitespace-nowrap rounded py-4 px-6 text-sm text-gray-700 transition duration-300 ease-in-out hover:bg-gray-100 hover:text-gray-900"
            ...
            >
              <li className="relative">
                <a
                  href="#!"
                  className="flex h-6 items-center overflow-hidden text-ellipsis whitespace-nowrap rounded py-4 pl-12 pr-6 text-xs text-gray-700 transition duration-300 ease-in-out hover:bg-gray-100 hover:text-gray-900"
                  data-mdb-ripple="true"
                  data-mdb-ripple-color="dark"
                >
                  Link 1
