            ...
            <div className="mt-6 w-full lg:mt-0 lg:w-1/2 lg:py-6 lg:pl-10">
              ...
              <div className="mt-6 mb-5 flex items-center border-b-2 border-gray-800 pb-5">
                <div className="flex">
                  ...
                  <button className="ml-1 h-6 w-6 rounded-full border-2 border-gray-800 bg-indigo-500 focus:outline-none"></button>
                </div>
                <div className="ml-6 flex items-center">
                  <span className="mr-3">Size</span>
                  <div className="relative">
                    <select className="appearance-none rounded border border-gray-700 bg-transparent py-2 pl-3 pr-10 text-white focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-900">
                      <option>SM</option>
                      <option>M</option>
                      <option>L</option>
                      <option>XL</option>
