    ...
    <>
      ...
      {open ? (
        <div
          ...
          border-l-2 border-gray-300 bg-white px-6 py-4 transition duration-300"
        >
          <div className="flex items-center justify-between">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="md:flex md:items-center">
            <div className="h-64 w-full md:w-1/2 lg:h-96">
              <img
                className="mx-auto h-full w-full max-w-lg rounded-md object-cover"
            ...
            <div className="mx-auto mt-5 w-full max-w-lg md:ml-8 md:mt-0 md:w-1/2">
              <h3 className="text-lg uppercase text-gray-700">Nike Air</h3>
              ...
              <div className="mt-3">
                ...
                <div className="mt-1 flex items-center">
                  <button className="mr-2 h-5 w-5 rounded-full border-2 border-blue-200 bg-blue-600 focus:outline-none"></button>
                  <button className="mr-2 h-5 w-5 rounded-full bg-teal-600 focus:outline-none"></button>
                  <button className="mr-2 h-5 w-5 rounded-full bg-pink-600 focus:outline-none"></button>
                </div>
              </div>
              <div className="mt-6 flex items-center">
                <button className="rounded bg-indigo-600 px-8 py-2 text-sm font-medium text-white hover:bg-indigo-500 focus:bg-indigo-500 focus:outline-none">
                  Order Now
                </button>
