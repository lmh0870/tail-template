    ...
    <>
      <div className="py-8">
        <button
          ...
          className="rounded bg-indigo-600 py-2 px-10
             text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2"
        >
          Open Modal
        </button>
      </div>
      ...
      {open ? (
        <div
          className="sticky-0 fixed top-0 h-full w-full overflow-y-auto overflow-x-hidden bg-gray-800 bg-opacity-90"
          id="chec-div"
        >
          <div
          ...
          >
            <div className="absolute right-0 h-screen overflow-y-auto bg-gray-50 p-8 2xl:w-4/12">
              ...
              <div className="mt-4 flex w-full flex-shrink-0 rounded bg-white p-3 shadow">
                <div
                  aria-label="group icon"
                  role="img"
                  className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-gray-200 focus:outline-none"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              <div className="mt-4 flex w-full rounded bg-white p-3">
                <div
              ...
              <div className="mt-4 flex w-full items-center rounded bg-red-100 p-3">
                <div
                  aria-label="storage icon"
                  role="img"
                  className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-red-200 focus:outline-none"
                >
                  <svg
                    width="16"
                    height="16"
                ...
                <div className="flex w-full items-center justify-between pl-3">
                  <p className="text-sm leading-none text-red-700 focus:outline-none">
                    Low on storage: 2.5/32gb remaining
                  </p>
                  <p className="cursor-pointer text-right text-xs leading-3 text-red-700 underline focus:outline-none">
                    Manage
                  </p>
                </div>
              </div>
              ...
              <h2 className="border-b border-gray-300 pt-8 pb-2 text-sm leading-normal text-gray-600 focus:outline-none">
                YESTERDAY
              </h2>
              <div className="mt-6 flex w-full rounded bg-white p-3">
                <div
                  aria-label="post icon"
                  role="img"
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 focus:outline-none"
              ...
              <div className="mt-8 flex w-full items-center rounded bg-green-100 p-3">
                <div
                  aria-label="success icon"
                  role="img"
                  className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-green-200 focus:outline-none"
                >
                  <svg
                    width="16"
                    height="16"
                ...
                <div className="w-full pl-3">
                  <div className="flex items-center justify-between">
                    <p className="text-sm leading-none text-green-700 focus:outline-none">
                      Design sprint completed
                    </p>
                    <p className="cursor-pointer text-xs leading-3 text-green-700 underline focus:text-indigo-600 focus:outline-none">
                      View
                    </p>
                  </div>
                </div>
