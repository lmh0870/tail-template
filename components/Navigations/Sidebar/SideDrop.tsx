  ...
  return (
    <>
      <div>
        ...
        <div
          id="Main"
          className="flex h-full w-full transform flex-col items-start justify-start
          bg-gray-900
          transition duration-500 ease-in-out
          sm:w-64
          xl:translate-x-0 xl:rounded-r"
        >
          <div
            className="hidden
          ...
          >
            <button
              className="jusitfy-start
              flex w-full items-center
              space-x-6
              rounded
              text-white
              focus:text-indigo-400 focus:outline-none"
            >
              <svg
          ...
          >
            <button
              ...
              py-5
              text-left
              text-white focus:text-indigo-400 focus:outline-none  "
            >
            ...
            >
              ...
              <button
                ...
                text-gray-400
                hover:bg-gray-700 hover:text-white
                focus:bg-gray-700  focus:text-white md:w-52"
              >
                <svg
                  width="24"
                  height="24"
          ...
          >
            <button
              ...
              focus:text-indigo-400 focus:outline-none"
            >
              <p className="text-sm uppercase leading-5">VENDORS</p>
              <svg
                id="icon2"
            ...
            <div
              className="flex hidden flex-col items-start justify-start
              pb-5
              "
            >
              <button
          ...
          >
            <button
              ...
              focus:text-indigo-400 focus:outline-none"
            >
              <p className="text-sm uppercase leading-5">SERVICES</p>
              <svg
                id="icon3"
                className="rotate-180 transform"
                width="24"
            ...
            >
              <button
                className="flex w-52 items-center justify-start
                space-x-6
                rounded
                px-3 py-2
                text-gray-400
              ...
              <button
                className="flex w-52 items-center justify-start space-x-6
                rounded
                px-3 py-2
                text-gray-400
                hover:bg-gray-700 hover:text-white
            ...
            <div className="flex w-full items-center justify-between">
              ...
              >
                ...
                <div className="flex flex-col items-start justify-start">
                  ...
                  <p
                    className="cursor-pointer
                    text-xs leading-3 text-gray-300"
                  >
                    alexis81@gmail.com
                  </p>
                </div>
