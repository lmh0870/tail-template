    ...
    <>
      ...
      >
        ...
        <div
          ...
          w-64 transform overflow-y-auto bg-gray-900 transition duration-300 lg:static lg:inset-0 lg:translate-x-0"
        >
          ...
          <nav className="mt-10">
            <a
              className="mt-4 flex items-center bg-gray-700 bg-opacity-25 py-2 px-6 text-gray-100"
              href="#"
            >
              <svg
                className="h-6 w-6"
