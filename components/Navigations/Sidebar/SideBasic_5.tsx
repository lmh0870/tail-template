      ...
      <div className="h-full w-full">
        <div className="flex-no-wrap flex">
              ...
              <div className="mt-48 mb-4 flex w-full justify-center">
                <div className="relative">
                  ...
                  <input
                    ...
                    py-2 pl-10
                    text-sm text-gray-300 placeholder-gray-400
                    focus:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-100"
                    type="text"
                    placeholder="Search"
                  />
                </div>
          ...
          <div
            ...
            md:w-4/5"
          >
            <div className="h-full w-full rounded border-2 border-dashed border-gray-300"></div>
          </div>
        </div>
      </div>
    </>
