  ...
  return (
    <>
      <nav className="bg-white">
        ...
        >
          <a
            className="block text-center text-2xl font-bold text-gray-800 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 lg:text-3xl"
            href="#"
          >
            Brand
          </a>

          <div className="mt-6 flex items-center justify-center capitalize text-gray-600 dark:text-gray-300">
            <a
              href="#"
              className="mx-1.5 border-b-2 border-blue-500 text-gray-800 dark:text-gray-200 sm:mx-6"
            >
              home
            </a>
            ...
            <a
              href="#"
              className="mx-1.5 border-b-2 border-transparent hover:border-blue-500 hover:text-gray-800 dark:hover:text-gray-200 sm:mx-6"
            >
              features
            </a>
